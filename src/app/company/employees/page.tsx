...
import { fetchEmployees } from '../../lib/api'; // Import the fetch function
import {Employee} from '../../lib/types'; // Import the Client type
...
const EmployeeTable = () => {
    ...
    const handleDetails = (id: number) => {
        console.log(`View more details for employee with id: ${id}`);
    };
    ...
    return (
        <div className="p-4">
            <h1 className="text-4xl font-bold text-[#3450A3] mb-8">Employees</h1>
